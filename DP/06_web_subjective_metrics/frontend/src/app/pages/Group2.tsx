...
import memeImg  from "../data/group2.png";
import attentionImg from "../data/clipper_attention.jpg";
import occlusionImg from "../data/clipper_occlusion.jpg";
import gradcamImg from "../data/clipper_gradcam.jpg";
...
export default function Group2({ studentId, onComplete }: Group2Props) {
  const [explanations, setExplanations] = useState<Record<string, Record<string, number>>>({});
  
  const groupMethods: Method[] = methods.group2;
